...
SETUP() {
    MYCONFIG=$(readlink -f "$VMDIR/tests/merges-no-stat.cfg")
...
CHECK() {
    ...
    T_check_different "folder1/My Pictures/Holiday 2/photo.jpg" || return 1
    ...
    T_check_missing "mirror/folder1/My Pictures/Holiday 2/photo.jpg.2" || return 1
    T_check_same "folder1/My Pictures/Holiday 2/Videos/seagull.mp4" || return 1
    T_check_different "folder1/My Pictures/Holiday 2/Videos/a smile.mp4" || return 1
    return 0
}
